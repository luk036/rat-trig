...
TEST_CASE("Testing dot function") {
    ...
    SUBCASE("Test with fractions (using doubles)") {
        ...
        CHECK(rat_trig::dot(v1, v2) == doctest::Approx(expected).epsilon(1e-10));
    }
}